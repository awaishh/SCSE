    ...
    <div className="min-h-screen bg-white text-[#111827]">
      ...
      <nav className="border-b border-gray-100 px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-500">Rankings</span>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">The most elite coders in the Arena</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border-2 border-dashed border-gray-200 rounded-xl">
            <p className="text-gray-400 text-sm">No rankings yet. Complete matches to appear!</p>
          </div>
        ) : (
              ...
              {leaders.map((player, index) => (
                ...
                >
                  ...
                  <div className="col-span-4 flex items-center gap-3">
                    ...
                    <span className="font-bold text-[#111827]">{player.name}</span>
                  </div>
                  <div className="col-span-2 flex justify-center">
                    <span className={`text-xs font-bold ${RANK_COLORS[player.rankTier] || "text-gray-500"}`}>
                      {player.rankTier}
                    </span>
                  </div>
                  ...
                  <div className="col-span-1 text-right text-emerald-600 font-semibold text-sm">
                    {player.wins}
                  </div>
                  <div className="col-span-1 text-right text-red-500 font-semibold text-sm">
                    {player.losses}
                  </div>
                  <div className="col-span-1 text-right font-bold text-sm text-[#111827]">
                    {player.winRate}
                  </div>
                </div>
              ))}
